...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__modules_count__ = __webpack_require__(3);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__modules_prevImg__ = __webpack_require__(4);
...
Object(__WEBPACK_IMPORTED_MODULE_0__modules_count__["a" /* default */])();
Object(__WEBPACK_IMPORTED_MODULE_1__modules_prevImg__["a" /* default */])();
...
// 画像ライブプレビュー
function prevImg() {
  var $dropArea = __WEBPACK_IMPORTED_MODULE_0_jquery___default()('.js-area-drop');
  var $fileInput = __WEBPACK_IMPORTED_MODULE_0_jquery___default()('.js-input-file');

  $dropArea.on('dragover', function (e) {
    e.stopPropagation();
    e.preventDefault();
    __WEBPACK_IMPORTED_MODULE_0_jquery___default()(this).css('border', '3px #ccc dashed');
  });
  $dropArea.on('dragleave', function (e) {
    e.stopPropagation();
    e.preventDefault();
    __WEBPACK_IMPORTED_MODULE_0_jquery___default()(this).css('border', 'none');
  });
  ...
  $fileInput.on('change', function (e) {
    ...
    var file = this.files[0],
        // files配列にファイルが入っている
    $img = __WEBPACK_IMPORTED_MODULE_0_jquery___default()(this).siblings('.js-prev-img'),
...
/* harmony default export */ __webpack_exports__["a"] = (prevImg);
...
function fixFooter() {
  // フッターを最下部に固定
  var $ftr = __WEBPACK_IMPORTED_MODULE_0_jquery___default()('.js-footer');
...
/* harmony default export */ __webpack_exports__["a"] = (fixFooter);
...
function showMsg() {
  // メッセージ表示
  var $jsShowMsg = __WEBPACK_IMPORTED_MODULE_0_jquery___default()('.js-show-msg');
...
/* harmony default export */ __webpack_exports__["a"] = (showMsg);
...
function confirm() {
  ...
  __WEBPACK_IMPORTED_MODULE_0_jquery___default()('.js-btn-del').on('click', function (e) {

    if (window.confirm(__WEBPACK_IMPORTED_MODULE_0_jquery___default()('.js-btn-del').data('message'))) {
